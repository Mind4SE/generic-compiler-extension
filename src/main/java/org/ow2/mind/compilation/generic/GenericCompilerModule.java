 ...
 * {@link GenericCompilerModule} class.
 */
public class GenericCompilerModule extends AbstractMindModule {

  protected void configureCompilerWrapper() {
    bind(CompilerWrapper.class).to(GenericCompilerWrapper.class);
  }
}
